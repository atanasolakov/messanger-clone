           ...
           <form onSubmit={handleSubmit(onSubmit)}>
             <div className={'space-y-12'}>
                 <div className={'border-b border-gray-900/10 pb-12'}>
                   <h2 className={'text-bas font-semibold leading-7 text-gray-900'}>Profile</h2>
                     ...
                     <div className={'mt-10 flex flex-col gap-y-8'}>
                         ...
                         <div className={'mt-2 flex items-center gap-x-3'}>
                          <Image  width={'48'} height={'48'} className={'rounded-full'} alt={'Avatar'}
                             ...
                             <CldUploadButton onUpload={handleUpload} options={{maxFiles: 1}} uploadPreset={'gtjukend'}>
                 ...
                 <div className={'mt-6 flex items-center justify-end gap-x-6'}>
                     ...
                     <Button disabled={isLoading} secondary type={'submit'}>Save</Button>
                 </div>
             </div>
           </form>
       </Modal>
