         ...
         <Dialog as="div" className={'relative z-50'} onClose={onClose}>
           <Transition.Child as={Fragment} enter={'ease-out duration-500'}
              enterFrom={'opacity-0'} enterTo={'opacity-100'}
               leave={'ease-in duration-500'} leaveFrom={'opacity-100'}
                      leaveTo={'opacity-0'}>
             ...
             <div className={'fixed inset-0 overflow-hidden'}>
                 <div className={'absolute inset-0 overflow-hidden'}>
                     <div className={'pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10'}>
                      ...
                      leaveTo={'translate-x-full'} enterFrom={'translate-x-full'}>
                        <Dialog.Panel className={'pointer-events-auto w-screen max-w-md'}>
                          <div className={'flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl'}>
                              <div className={'px-4 sm:px-6'}>
                                  <div className={'flex items-start justify-end'}>
                                      <div className={'ml-3 flex h-7 items-center'}>
                                          <button onClick={onClose} className={'rounded-md bg-white hover:text-gray-500 text-gray-400 focus:outline-none' +
